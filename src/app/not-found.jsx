        ...
        <section className="min-h-screen bg-[#F8F7F4] flex items-center justify-center px-6">
            <div className="max-w-6xl mx-auto items-center">
                <div>
                    ...
                    <h1
                        className={`${playFair.className} text-5xl md:text-7xl font-bold leading-tight text-[#1E1E1E]`}
                    >
                        Page Not <br /> Found
                    </h1>
                    ...
                    <div className="flex flex-wrap gap-4 mt-10">
                        ...
                        <Link href="/all-tiles">
                            <button className="flex items-center gap-2 border border-gray-300 px-7 py-4 rounded-full text-sm font-medium hover:bg-white hover:scale-105 cursor-pointer transition-all duration-300">
                                <Search size={18} />
                                Browse Tiles
                            </button>
                        </Link>
